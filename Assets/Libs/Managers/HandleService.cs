...
public class HandleService
{
    public static void processData(JObject jsonData)
    {
        ...
        if (jsonData.ContainsKey("evt"))
        {
            ...
            if (evt != "updatejackpot" && evt != "salert") Globals.Logging.Log("--------------------------------------------------->EVT: " + evt + " <------------------------------------------->\n" + jsonData);
            switch (evt)
            {
                case "promotion_info":
                ...
                case "GiftCode":
                    {
                        int gold = Promotion.giftCode = (int)jsonData["G"];
                ...
                case "updatejackpot":
                    {
                        ...
                        if (Config.curGameId == (int)GAMEID.BORKDENG && UIManager.instance.gameView != null)
                        {
                ...
                case "jackpothistory":
                    {
                        ...
                        if (JackpotBorkView.instance != null && JackpotBorkView.instance.gameObject.activeSelf)
                        {
                            JackpotBorkView.instance.SetInfo(jsonData);
                        }
