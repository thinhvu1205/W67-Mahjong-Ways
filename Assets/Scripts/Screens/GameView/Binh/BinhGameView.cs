...
{
    public static BinhGameView instance;
    ...
    public void _HandleAnimJackpot(JObject data)
    {
        ...
        playerP.playerView.chipJackpot = (int)data["M"];
        showJackpotWin((int)data["M"]);
    }
    private void showJackpotWin(int M)
    {
    ...
    public void UpdateJackPot()
    {
        ...
        for (int i = 0; i < str.Length; i++)
        {
            ...
            m_JackPotNumberTMPs[i].gameObject.transform.localScale = Vector3.one;
