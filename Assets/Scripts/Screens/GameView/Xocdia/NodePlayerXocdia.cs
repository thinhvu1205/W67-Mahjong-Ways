...
public class NodePlayerXocdia : BaseView
{
    // Start is called before the first frame update
    [SerializeField] GameObject item_player;
    [SerializeField] ScrollRect list_player;
    XocdiaView xocDiaView;


    protected override void OnEnable()
    {
        base.OnEnable();
        xocDiaView = (XocdiaView)UIManager.instance.gameView;
        loadListPlayer();
    }
    public void loadListPlayer()
    {
        List<Player> list_data_player = xocDiaView.listPlayerXocdia;
