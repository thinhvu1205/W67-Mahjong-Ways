...
public class SiXiangBuyPealsPopup : BaseView
{
    ...
    public void setInfo(int indexGem, int pricePearl, int bet, long agPlayer)
    {
        ...
        lbInfo.text = "បង់ " + Config.FormatNumber(price) + " ឈីប ដើម្បីទទួលបានគ្រាប់ត្បូងនេះ!";//Globals.Config.formatStr(Globals.Config.getTextConfig("text_sixiang_buy_gem"), Globals.Config.FormatNumber(price));
    }
