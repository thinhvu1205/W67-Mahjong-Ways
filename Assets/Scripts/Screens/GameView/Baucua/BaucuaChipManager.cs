...
public class BaucuaChipManager : MonoBehaviour
{
    [SerializeField] private List<GameObject> m_ListSprChip;
    [SerializeField] private TextMeshProUGUI m_ValueChip;
    public BaucuaGameView BaucuaGameView;
    public List<long> ListValueChip = new List<long>();
    public void SetListValueChip(List<long> listValueChip)
    {
