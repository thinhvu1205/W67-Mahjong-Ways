...
public class PlayerViewLucky89 : PlayerView
{
    ...
    public PlayerViewLucky89 ShowAnimResult(bool show, long changedChips)
    {
        ...
        if (!show) return this;
        if (isWin) m_WinSg.AnimationState.SetAnimation(0, "wincam", false);
        if (isDraw) m_DrawSG.AnimationState.SetAnimation(0, "draw_thai", false);
        if (isLose) m_LoseSg.AnimationState.SetAnimation(0, "lose_cam", false);
        return this;
    }
