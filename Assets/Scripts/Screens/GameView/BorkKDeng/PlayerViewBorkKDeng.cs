    ...
    public void showScoreCard()
    {
        ...
        if (numCard == 2)
        {
            if (score == 9)
            {
                ...
                animQiu.AnimationState.SetAnimation(0, "bork9_cam", false);

                Debug.Log("xem điểm như nao" + score);
            }
            else if (score == 8)
            {
                bgScore.gameObject.SetActive(true);
                ...
                lbScore.gameObject.SetActive(false);
                animQiu.Initialize(true);
                animQiu.AnimationState.SetAnimation(0, "bork8_cam", false);
        ...
        else if (numCard == 3)
        {
            ...
            else
            {
                ...
                if (score == 11) lbScore.text =  Globals.Config.getTextConfig("txt_pok_sanh");
                if (score == 12) lbScore.text =  Globals.Config.getTextConfig("txt_pok_tpsanh");
                if (score == 13) lbScore.text =Globals.Config.getTextConfig("txt_pok_3daunguoi");
